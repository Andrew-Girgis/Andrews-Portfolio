...
export const HOTSPOT_CONFIG: Record<string, HotspotProduct> = {
  "Monitor-1-Outline": {
    ...
    description:
      "My secondary display I use to increase productivity and multitask efficiently.",
  ...
  "Monitor-3-Outline": {
    name: "Dell P2422HE 24' inch Monitor",
    description:
      "My Tertiary display which I use for reading feeds, Slack/Discord messages and articles.",
    link: "https://amzn.to/4oWm6CT",
  },
  "Keyboard-Outline": {
    name: "KVM Switch",
    description:
      "Seamlessly switch keyboard, mouse, and monitors between my MacBook Air and custom PC.",
    link: "https://amzn.to/48lVswi",
  },
  "Keyboard-Outline1": {
    name: "Lofree Flow84 Mechanical Keyboard",
    description:
      "Low-profile mechanical keyboard with Phantom switches. Love it for the tactile feel, subtle sounds, and compact travel-friendly design.",
  ...
  "Custom-PC-Outline": {
    name: "Omphalos",
    description:
      "A custom PC I built myself. It features a 3070 GPU, Intel i9 CPU, and 32GB RAM for larger data science, and machine learning tasks and some occasional gaming. Currently running dual boot Omarchy and Windows on it.",
  ...
  "Mouse-Outline": {
    ...
    description:
      "I really enjoy this mouse from its design to the thumb wheel and button for multi gesture use",
  ...
  "Mic-Outline": {
    ...
    description:
      "I use this for improvement in audio quality in meetings, and videos.",
    link: "https://amzn.to/48vE3lO",
  },
  "Camera-Outline": {
    name: "Logitech StreamCam",
    description: "My go-to camera for clear video in calls and content.",
    link: "https://amzn.to/48uzPLk",
  },
  "Macbook-Outline": {
    name: "M4 MacBook Air",
    description:
      "I am a big fan of the Apple ecosystem. I love the seemless integration between my MacBook Air and iPhone for my daily tasks.",
    link: "https://amzn.to/4rhRI7A",
  },
  "Headphones-Outline": {
    name: "Nothing headphones (1)",
    description:
      "Currently my favorite pair of over-ear headphones for daily use. Fantastic sound quality and great design.",
    link: "",
  },
  "smiski-outline": {
    name: "Smiski Figure",
